...
[{{url_scheme}}{{ base_url }}:9090]({{url_scheme}}{{ base_url }}:9090)
...
[{{url_scheme}}{{ base_url }}:9090/redoc]({{url_scheme}}{{ base_url }}:9090/redoc)
...
[{{url_scheme}}{{ base_url }}:8080]({{url_scheme}}{{ base_url }}:8080}})

Click play, and when requested.


If you do have a minecraft client you can use the following details to connect:
